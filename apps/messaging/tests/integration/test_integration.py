...
class MessagingIntegrationFlowTest(TestCase):
    ...
    def setUp(self):
        ...
        self.bid = Bid.objects.create(
            ...
            cover_letter="Certified K8s administrator.",
    ...
    def test_message_exchange_and_read_receipt_flow(self):
        # 1. Create conversation for contract participants
        ...
        read_url = reverse("messaging-conversation-mark-read", kwargs={"pk": conversation.id})
