...
const FreelancerMessagesPage = () => {
  ...
  const getOtherUserName = (conv) => {
    ...
    if (conv?.contract?.client?.full_name) return conv.contract.client.full_name
    if (conv?.contract?.client?.email) return conv.contract.client.email
            ...
            <div className="py-16 text-center px-4">
              ...
              <p className="text-xs text-gray-400 max-w-xs mx-auto">
                {search
                  ...
                  : 'Your contract communications will appear here.'}
              </p>
            </div>
          ) : (
            filtered.map((conv) => {
          ...
          <div className="flex-1 flex items-center justify-center p-6">
            <div className="text-center max-w-sm">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">
                Select a client conversation from the list to start messaging in real-time.
              </p>
            </div>
          </div>
        ) : (
