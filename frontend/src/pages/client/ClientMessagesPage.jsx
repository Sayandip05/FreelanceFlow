...
const ClientMessagesPage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Sidebar active="/client/messages" />
              ...
              filtered.map((conv) => {
                ...
                return (
                  <button key={conv.id} onClick={() => setSelected(conv)}
                    className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 transition-colors border-b border-gray-50 text-left ${selected?.id === conv.id ? 'bg-primary-50' : ''}`}>
                    <div className="relative">
                      <Avatar name={name} />
                      {conv.has_unread && (
              ...
              <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 flex items-center gap-1">
                    <CircleDot className="w-3 h-3 text-green-500" /> Freelancer
                  </p>
                </div>
              </div>
