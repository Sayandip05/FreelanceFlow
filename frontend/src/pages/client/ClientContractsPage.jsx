      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xl font-black text-gray-900">{formatCurrency(totalCommittedBudget, 'INR')}</p>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-6 border-b border-gray-100">
                    ...
                    <div className="grid grid-cols-3 gap-4 bg-gray-50/80 rounded-2xl p-4 border border-gray-100 text-center flex-shrink-0">
                      <div>
                        ...
                        <p className="text-base font-black text-gray-900 mt-0.5">{formatCurrency(budget, 'INR')}</p>
                      </div>
